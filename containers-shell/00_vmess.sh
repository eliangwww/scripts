...
export ARGO_DOMAIN=${ARGO_DOMAIN:-'argo.hujunge.nyc.mn'}      # ARGO 固定隧道域名，留空将使用临时隧道
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiN2ViYjU3OGNmYTM3MjI5YmE5NzM1NjUyZmI1NjU5NDEiLCJ0IjoiMDY1MDNjNzktNzEzMS00MzFhLTk0YmYtY2JmNDdiNDg4MjQxIiwicyI6Ik1tTTFORGs0WVRFdE5UVm1aQzAwTWpNeUxUZ3dNR1F0TXpGaE5qQTRNVGcyT1RjMiJ9'}         # ARGO 固定隧道json或token，留空将使用临时隧道
export CFIP=${CFIP:-'cf.090227.xyz'}   # 优选ip或优选域名
export CFPORT=${CFPORT:-'443'}          # 优选ip或优选域名对应端口  
export PORT=${PORT:-'11395'}           # ARGO端口必填
